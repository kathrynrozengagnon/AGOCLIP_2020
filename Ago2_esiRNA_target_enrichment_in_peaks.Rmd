...
res_Ago2_FL <- annotatePeaksWithPatterns(peaks=allGR,
                                ...
                                patterns="/Users/kathryn/Reprocess_all_paper_datasets/seed_search_refseqs/Ago2_known_and_novel_miRNAs_6mer_target.fa",
                                  resize=406,
                                  add5=11,
                                  add3=1,
                                  verbose=TRUE)
...
seeds_df <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_tables/Table_S6_Resource_paper.txt", header=TRUE, sep="\t")
...
Ago2_sRNAs <- readDNAStringSet("/Users/kathryn/Reprocess_all_paper_datasets/seed_search_refseqs/Ago2_known_and_novel_miRNAs_6mer_target.fa", format = "fasta")
Ago2_sRNAs_cells <- Ago2_sRNAs[!grepl("aegypti", names(Ago2_sRNAs))]
Ago2_sRNAs_aegypti <- Ago2_sRNAs[!grepl("Aag2", names(Ago2_sRNAs))]
...
Ago2_eight <- Ago2_tom
Ago2_tom <- Ago2_tom%>% group_by(.dots=c("six_mer_target", "six_mer", "aae_miRNA_family")) %>% summarise(smallRNAs = paste0(smallRNA, collapse = ":"),  FL_target_seqs = paste0(FL_target_seq, collapse = ":"))
...
res_Ago2_FL$perfect_18mer_target <- ifelse(res_Ago2_FL$check==TRUE, paste0(res_Ago2_FL$aae_miRNA_family), paste0("NA"))

res_Ago2_FL$check <- mapply(agrepl, pattern=res_Ago2_FL$SeqExtended, x=res_Ago2_FL$FL_target_seqs, max=1)
res_Ago2_FL$one_mis_18mer_target <- ifelse(res_Ago2_FL$check==TRUE, paste0(res_Ago2_FL$aae_miRNA_family), paste0("NA"))
