...
##Reprocess all datasets of interest together 
...
```{r}
#FastX to split samples by index:
...
```{r}
#bowtie2 indices were previously made
#Ae. aegypti genome fasta (AaegL5) used to make index available at: https://www.vectorbase.org/downloads
#CFAV genome fasta is available at: 
#https://www.ncbi.nlm.nih.gov/nuccore/NC_001564
