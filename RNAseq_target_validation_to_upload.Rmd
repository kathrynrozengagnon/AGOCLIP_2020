...
input file "Table_S4_Resource_paper.txt" is available as a zip file in my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020)
```{r}
all_with_pats <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_tables/Table_S4_Resource_paper.txt", header = TRUE, sep="\t", stringsAsFactors = FALSE)
...
##GSVA for Ago1 ovary-specific miRNA targets (Supplementary Figure 7c)
...
##eCDFs of miRNA target expression, Figures 6a-c, Supplementary Figures 7a,b
...
##GSVA for Ago2, Supplementary Figure 7d
