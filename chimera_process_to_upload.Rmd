...
```
All of the above chimera processing steps can now be accomplished using CLIPflexR's [chimera_Process](https://kathrynrozengagnon.github.io/CLIPflexR/reference/chimera_process.html) function; bam files are the inputs and chimera processed, remapped beds are the outputs
