...
```{r}
##get unmapped reads from bam; bams were generated in "Processing" script; data available upon request
...
##now need to read in remapped chimeric reads, concatenate beds by group and write grouped bed/bigwigs
...
n <- gsub("/Users/kathryn/Reprocess_all_paper_datasets/unmapped_for_chimera/known_novel_sRNA_revmapped/alternative_processing/", "", t)
n <- gsub("_chimera.txt.bed", "", n)
names(chimera) <- n

#get remapped chimeras by antibody/lysate and write out concatenated beds 
aegyptiAgo1 <- grep("aegypti_Ago1", n, value = TRUE)
aegyptiAgo2 <- grep("aegypti_Ago2", n, value = TRUE)
aegyptirIgG <- grep("aegypti_rIgG", n, value = TRUE)
aegyptimIgG <- grep("aegypti_mIgG", n, value = TRUE)
Aag2Ago1 <- grep("Aag2_Ago1", n, value = TRUE)
Aag2Ago2 <- grep("Aag2_Ago2", n, value = TRUE)
Aag2rIgG <- grep("Aag2_rIgG", n, value = TRUE)
Aag2mIgG <- grep("Aag2_mIgG", n, value = TRUE)
