...
##read in table of perfect or imperfect targets by antibody/lysate
aegypti_perf <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_Figs/aegypti_Ago2_perfect_df_BCsample.txt", header = TRUE,  sep = "\t")
Aag2_perf <-  read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_Figs/Aag2_Ago2_perfect_df_BCsample.txt", header = TRUE,  sep = "\t")
aegypti_pat_chim <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_Figs/aegypti_Ago2_pat_chim_df_top_chim_BCsample2_no_perf.txt", header = TRUE,  sep = "\t")
Aag2_pat_chim <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_Figs/Aag2_Ago2_pat_chim_df_top_chim_BCsample2_no_perf.txt", header = TRUE,  sep = "\t")
...
go_merge_over_pval <- go_merge[,c(2, 4,8,12,16)]
row.names(go_merge_over_pval) <- go_merge_over_pval[,c(1)]
go_merge_over_pval <- go_merge_over_pval[,c(2:5)] #take higher significance because many terms 
go_merge_over_pval <- as.matrix(subset(go_merge_over_pval, go_merge_over_pval$over_represented_pvalue_cells_pat_chim <0.01 | go_merge_over_pval$over_represented_pvalue_cells_perf <0.01 | go_merge_over_pval$over_represented_pvalue_aegypti_pat_chim <0.01 | go_merge_over_pval$over_represented_pvalue_aegypti_perf <0.01))

#simplfy by semantic redundancy, keep the most unique terms (from REVIGO, only BPs)
BP <- read.csv("/Users/kathryn/Reprocess_all_paper_datasets/GO_analysis/REVIGO_sig_over_BP_thru500.csv", header = TRUE)
