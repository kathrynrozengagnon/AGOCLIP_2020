...
Bed files are too large for upload but are available upon request; "Table_S4_Resource_paper.txt"" is available on my [Github](https://github.com/kathrynrozengagnon/AGOCLIP_2020)
```{r }
#read in all peaks
all <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_tables/Table_S4_Resource_paper.txt", sep = "\t", header = TRUE)
