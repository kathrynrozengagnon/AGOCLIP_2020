...
```{r }
#read in all peaks
all <- read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Supp_Figs/Final_matrix_all_peaks_021520.txt", sep = "\t", header = TRUE)
...
#read in all mapped reads, concatenated by antibody/lysate
