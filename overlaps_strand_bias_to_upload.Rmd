...
#read in all mapped reads, concatenated by antibody/lysate; data are too large to upload to gtihub; available upon request or raw unprocessed reads can be obtained at GEO: ###
...
lread_bind <-read.delim("/Users/kathryn/Reprocess_all_paper_datasets/Rmds_to_upload/To_upload/overlapping_read_counts.txt",  header = TRUE, stringsAsFactors = FALSE, sep= "\t")
...
ks.test(subset(lread_Aag2$log10length_nosense, lread_Aag2$sample=="cat_Aag2Ago1.bed"), subset(lread_Aag2$log10length_nosense, lread_Aag2$sample=="cat_Aag2Ago2.bed"),alternative = c("less"))

ks.test(subset(lread_aegypti$log10length_nosense, lread_aegypti$sample=="cat_aegyptiAgo1.bed"), subset(lread_aegypti$log10length_nosense, lread_aegypti$sample=="cat_aegyptiAgo2.bed"),alternative = c("less"))
