...
##Reprocessing steps of small RNA-seq from Akbari et al. 2013 are shown but were commented out because the files are very large

```{r}
# #small RNA seq data were downloaded from ENA: https://www.ebi.ac.uk/ena/browser/home
# #accession: PRJNA612346
#
...
# bplapply(x= "/rugpfs/fs0/rice_lab/scratch/krozen/Akbari_check_esiRNAs/all_unique_filt_sRNAs_rn.fa", bowtie_align, index= ref)
# 
# for (i in unmapped) {
...
```{r}
#processed and mapped files available on my github: reprocessed_smallRNA_seq_from_Akbari_2013.zip
...
##Classify by small RNA type in ovary (blood-fed and nonblood-fed), embryos, and carcasses  (all female) and graph expression in rpm 
