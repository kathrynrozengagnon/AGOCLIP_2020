...
chimera bedfiles remapped to the AaegL5 genome, "chimera_beds.zip", were generated in the *chimera_process_to_upload* script and are available on my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020) 
```{r}
...
need raw miRNA counts to normalize with a pseudocount of 1 for log2 visualization: "novel_miRNAs_filtered_counts_all_info.txt", "known_miRNAs_allcols.txt", and "all_putative_known_sRNA_seeds2.txt" files were generated in the *mirdeep2_processing_filtering_to_upload* script
All these input files are available in my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020)

Input fasta "aae_miRNAs_mature_fixed.fa" was downloaded from [miRBase](http://www.mirbase.org/ftp.shtml) and is available in my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020/tree/master/renamed_smallRNA_fastas)
```{r}
...
##Format Supplementary Table 3

Input file "novel_mirdeep_filtered.txt" file was generated in the *mirdeep2_processing_filtering_to_upload* script and is available in my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020)  
  
miRNAs fastas "aae_miRNAs_mature_fixed.fa", "aga_miRNAs_mature.fa" (*Anopheles gambiae*), "cqu_mature_fixed.fa" (*Culex quinquefasciatus*), and "dme_miRNAs_mature.fa" (*Drosophila melanogaster*) were downloaded from [miRBase](http://www.mirbase.org/ftp.shtml) and are available in my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020/tree/master/renamed_smallRNA_fastas)
...
```
output files "all_unique_filt_sRNAs_rn.fa" and "all_unique_filt_seeds_rn3.fa" are available on my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020/tree/master/renamed_smallRNA_fastas)

Supplementary Table 3, "Table_S3_Resource_paper.txt", is available on my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020)  

##rename fastas with final namess

these are the input fastas provided on my [Github](https://github.com/kathrynrozengagnon/AgoCLIP_2020/tree/master/renamed_smallRNA_fastas)
```{r}
